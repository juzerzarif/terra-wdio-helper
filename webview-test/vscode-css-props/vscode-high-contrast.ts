export default `
  ...
  --vscode-editor-font-family:Input, "JetBrains Mono", Consolas, "Courier New", monospace;
  ...
  --vscode-workspaceTrust-trustedForergound:#89d185;
  ...
  --vscode-gitlens-gutterUncommittedForegroundColor:#00bcf2;
  --vscode-gitlens-trailingLineBackgroundColor:rgba(0, 0, 0, 0);
  --vscode-gitlens-trailingLineForegroundColor:rgba(153, 153, 153, 0.6);
  ...
  --vscode-gitlens-closedPullRequestIconColor:#ff544b;
  --vscode-gitlens-openPullRequestIconColor:#68ff79;
  --vscode-gitlens-mergedPullRequestIconColor:#8945ff;
  --vscode-gitlens-unpushlishedChangesIconColor:#4dff88;
  --vscode-gitlens-unpublishedCommitIconColor:#4dff88;
  --vscode-gitlens-unpulledChangesIconColor:#ff874c;
  --vscode-gitlens-decorations.addedForegroundColor:#1b5225;
  --vscode-gitlens-decorations.copiedForegroundColor:#73c991;
  --vscode-gitlens-decorations.deletedForegroundColor:#c74e39;
  --vscode-gitlens-decorations.ignoredForegroundColor:#a7a8a9;
  ...
  --vscode-gitlens-decorations.branchAheadForegroundColor:#4dff88;
  --vscode-gitlens-decorations.branchBehindForegroundColor:#ff874c;
  --vscode-gitlens-decorations.branchDivergedForegroundColor:#d8af1b;
  --vscode-gitlens-decorations.branchUnpublishedForegroundColor:#4dff88;
